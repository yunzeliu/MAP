...
def get_args_parser():
    parser = argparse.ArgumentParser('MAP pretraining script', add_help=False)
    ...
    # Model parameters
    parser.add_argument('--model', default='map_small_patch16_224', type=str, metavar='MODEL',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('MAP training script', parents=[get_args_parser()])
